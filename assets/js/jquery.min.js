...
window.addEventListener("load",function(){var o=window.applicationCache;if(o.addEventListener("updateready",function(){o.status==o.UPDATEREADY&&(o.swapCache(),window.location.reload())},!1),navigator.onLine&&o.status!=o.UNCACHED)try{o.update()}catch(n){}},!1),jQuery(function(o){o("#goTop").goToTop(),o("#loader-wrap").fadeOut(),o(document).hideAddressBar()}),function(o){o.fn.hideAddressBar=function(){var n=navigator.userAgent;n.indexOf("Android")>0&&n.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollBy(0,1)},100)})}}(jQuery),function(o){o.fn.goToTop=function(){var n=o(this),t=o("body");o(window).scroll(function(){t.scrollTop()>100?n.fadeIn():n.fadeOut()}),n.click(function(){var t=400,e=n.attr("href"),i=o("#"==e||""==e?"html":e),a=i.offset().top+1;return o("body,html").animate({scrollTop:a},t,"swing"),!1})}}(jQuery);