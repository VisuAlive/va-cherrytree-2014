...
window.addEventListener("load",function(){var o=window.applicationCache;if(o.addEventListener("updateready",function(){o.status==o.UPDATEREADY&&o.swapCache()},!1),navigator.onLine&&o.status!=o.UNCACHED)try{o.update()}catch(t){}},!1),jQuery(function(o){o("#goTop").goToTop(),o("#loader-wrap").fadeOut(),setTimeout(scrollBy,100,0,1)}),function(o){o.fn.goToTop=function(){var t=o(this),n=o("body");o(window).scroll(function(){n.scrollTop()>100?t.fadeIn():t.fadeOut()}),t.click(function(){var n=400,a=t.attr("href"),e=o("#"==a||""==a?"html":a),i=e.offset().top+1;return o("body,html").animate({scrollTop:i},n,"swing"),!1})}}(jQuery);