...
jQuery(function(e){e(document).foundation(),e(document).standaloneMode(),e(document).parallaxBox(),e(document).masonryBox(),e(".entry-body table").respondTable();var t=e(".si_feed_list");t.length>0&&t.addClass("small-block-grid-3")}),function(e){e.fn.standaloneMode=function(){var t=window.navigator.standalone;t&&e("a").each(function(){var t=e(this).attr("href");"#"!==t&&"#wrap"!==t&&"undefined"!=typeof t&&(e(this).removeAttr("href"),e(this).click(function(){return location.href=t,!1}))})}}(jQuery),function(e){e.fn.parallaxBox=function(){var t=Modernizr.touch,n=e(".img-holder"),r=e(".parallax");n.length>0||r.length>0?(n.length>0&&(n.imageScroll({imageAttribute:t===!0?"image-mobile":"image",touch:t,mediaWidth:1280,mediaHeight:753}),e(".imageHolder .small-12").css("height",e(".imageHolder").height())),r.length>0&&(Modernizr.touch?(r.css("background-attachment","scroll"),r.removeAttr("data-stellar-background-ratio")):e.stellar({horizontalScrolling:!1,verticalOffset:40}))):e("body").addClass("not_parallax")}}(jQuery),function(e){e.fn.respondTable=function(){var t=e(this);if(t.length>0){var n=t.children("tbody").children("tr").length,r=t.children("tbody").children("tr").children("td").length,a=r/n;t.addClass("footable table").prepend('<thead style="display:none;"><tr></tr></thead>');for(var o=1;a>=o;o++)t.find("thead").find("tr").prepend("<th></th>");t.find("thead").find("tr").each(function(){e(this).children("th:not(:first)").attr({"data-hide":"phone"})}),t.footable().find("td").css("float","none")}else console.log("Error")}}(jQuery),function(e){e.fn.fixedBox=function(){{var t,n=e(this),r=e(window);n.height()}r.on("scroll touchmove touchstart",function(){t=r.scrollTop()>0?r.scrollTop():0,n.css({position:"relative",top:t,"z-index":"10"})})}}(jQuery),function(e){e.fn.masonryBox=function(){var t=e("#masonry");t.length>0&&t.masonry({itemSerector:".post",isAnimated:!0})}}(jQuery),jQuery(function(e){{var t=e(".editor-area").find("h2"),n=t.length;new Array(n)}e(".editor-area .entry-body").prepend('<h2>もくじ</h2><ul id="midashi"/>');for(var r=0;n>r;r++)e("#midashi").append("<li><a/></li>"),e("#midashi").children("li").children("a").eq(r).text(t.eq(r).text());for(var r=0;n>r;r++){var a="h2-"+r;t.eq(r).attr("id",a),e("#midashi").children("li").children("a").eq(r).attr("href","#"+a)}});