...
jQuery(function(o){var t=navigator.userAgent,n=Modernizr.touch,i=o(".img-holder"),e=window.navigator.standalone,r=o("a");o(document).foundation(),i.length>=1?o(".img-holder").imageScroll({imageAttribute:n===!0?"image-mobile":"image",touch:n,mediaWidth:1280,mediaHeight:753}):o("body").addClass("not_parallax"),o(window).load(function(){o("#goTop").goToTop(),o("#loader-wrap").fadeOut(),setTimeout(scrollBy,100,0,1)}),e&&r.each(function(){var t=o(this).attr("href");"#"!==t&&"#wrap"!==t&&"undefined"!=typeof t&&(o(this).removeAttr("href"),o(this).click(function(){return location.href=t,!1}))}),t.indexOf("Android")>0&&t.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)})}),function(o){o.fn.goToTop=function(){var t=o(this);o(window).scroll(function(){o("body").scrollTop()>100?t.fadeIn():t.fadeOut()}),t.click(function(){var n=400,i=t.attr("href"),e=o("#"==i||""==i?"html":i),r=e.offset().top+1;return o("body,html").animate({scrollTop:r},n,"swing"),!1})}}(jQuery);