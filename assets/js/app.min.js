...
jQuery(function(o){var n=navigator.userAgent;o(document).foundation(),n.indexOf("Android")>0&&n.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)})});