...
j();return k;}});})(jQuery);
jQuery(function(o){var n=navigator.userAgent,i=Modernizr.touch;o(document).foundation(),o(".img-holder").imageScroll({imageAttribute:i===!0?"image-mobile":"image",touch:i}),o(window).load(function(){o("#goTop").goToTop(),o(".loader-wrap").fadeOut(),setTimeout(scrollBy,100,0,1)}),n.indexOf("Android")>0&&n.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)})}),function(o){o.fn.goToTop=function(){var n=o(this);o(window).scroll(function(){o("body").scrollTop()>100?n.fadeIn():n.fadeOut()}),n.click(function(){var i=400,t=n.attr("href"),e=o("#"==t||""==t?"html":t),r=e.offset().top+1;return o("body,html").animate({scrollTop:r},i,"swing"),!1})}}(jQuery);