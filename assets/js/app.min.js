...
jQuery(function(o){var t=navigator.userAgent,e=Modernizr.touch,a=o(".img-holder"),i=o(".parallax"),n=window.navigator.standalone,r=o("a");if(o(document).foundation(),a.length>=1||i.length>=1){if(a.length>=1){o(".img-holder").imageScroll({imageAttribute:e===!0?"image-mobile":"image",touch:e,mediaWidth:1280,mediaHeight:753});var l=o(".imageHolder").height();o(".imageHolder .small-12").css("height",l)}i.length>=1&&(Modernizr.touch?(o(".parallax").css("background-attachment","scroll"),o(".parallax").removeAttr("data-stellar-background-ratio")):o.stellar({horizontalScrolling:!1,verticalOffset:40}))}else o("body").addClass("not_parallax");o(window).load(function(){o("#goTop").goToTop(),o("#loader-wrap").fadeOut(),setTimeout(scrollBy,100,0,1)}),n&&r.each(function(){var t=o(this).attr("href");"#"!==t&&"#wrap"!==t&&"undefined"!=typeof t&&(o(this).removeAttr("href"),o(this).click(function(){return location.href=t,!1}))}),t.indexOf("Android")>0&&t.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)})}),function(o){o.fn.goToTop=function(){var t=o(this);o(window).scroll(function(){o("body").scrollTop()>100?t.fadeIn():t.fadeOut()}),t.click(function(){var e=400,a=t.attr("href"),i=o("#"==a||""==a?"html":a),n=i.offset().top+1;return o("body,html").animate({scrollTop:n},e,"swing"),!1})}}(jQuery);