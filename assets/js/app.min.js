...
jQuery(function(e){var t=navigator.userAgent,a=Modernizr.touch,o=e(".img-holder"),i=e(".parallax"),l=window.navigator.standalone,n=e("a"),r=e(".entry-body table"),d=e(".si_feed_list");if(e(document).foundation(),l&&n.each(function(){var t=e(this).attr("href");"#"!==t&&"#wrap"!==t&&"undefined"!=typeof t&&(e(this).removeAttr("href"),e(this).click(function(){return location.href=t,!1}))}),t.indexOf("Android")>0&&t.indexOf("Mobile")>0&&e(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)}),o.length>0||i.length>0){if(o.length>0){e(".img-holder").imageScroll({imageAttribute:a===!0?"image-mobile":"image",touch:a,mediaWidth:1280,mediaHeight:753});var s=e(".imageHolder").height();e(".imageHolder .small-12").css("height",s)}i.length>0&&(Modernizr.touch?(e(".parallax").css("background-attachment","scroll"),e(".parallax").removeAttr("data-stellar-background-ratio")):e.stellar({horizontalScrolling:!1,verticalOffset:40}))}else e("body").addClass("not_parallax");r.length>0&&(r.wrap('<div class="table-responsive" data-pattern="priority-columns"></div>').addClass("table table-complex"),r.responsiveTable({adddisplayallbtn:!0,addfocusbtn:!1,fixednavbar:"#navbar"})),d.length>0&&d.addClass("small-block-grid-3")}),function(e){e.fn.fixedBox=function(){{var t,a=e(this),o=e(window);a.height()}o.on("scroll touchmove touchstart",function(){t=o.scrollTop()>0?o.scrollTop():0,a.css({position:"relative",top:t,"z-index":"10"})})}}(jQuery);