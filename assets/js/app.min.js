...
j();return k;}});})(jQuery);
jQuery(function(o){var i=navigator.userAgent,n=Modernizr.touch;o(document).foundation(),o(".img-holder").imageScroll({imageAttribute:n===!0?"image-mobile":"image",touch:n}),o(window).load(function(){o("#goTop").goToTop(),o(".loader-wrap").fadeOut(2e3),o("#wrap").css({visibility:"visible"}).hide().fadeIn(2500),o(".imageHolder").css({visibility:"visible"}).hide().fadeIn(2500),setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)}),i.indexOf("Android")>0&&i.indexOf("Mobile")>0&&o(window).on("load resize",function(){setTimeout(function(){0==document.body.scrollTop&&window.scrollTo(0,1)},100)})}),function(o){o.fn.goToTop=function(){var i=o(this);o(window).scroll(function(){o("body").scrollTop()>100?i.fadeIn(500):i.fadeOut(500)}),i.click(function(){var n=400,e=i.attr("href"),t=o("#"==e||""==e?"html":e),d=t.offset().top+1;return o("body,html").animate({scrollTop:d},n,"swing"),!1})}}(jQuery);